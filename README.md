...
![Lab topology](files/01-lab-topology.png)
...
![Agent registration on the manager](files/04-agent-registration.png)
![Importing the key into the Windows agent](files/05-agent-key-import.png)

Once connected, the agent appeared as active on the manager, confirming
two-way communication.

![Agent active in the dashboard](files/06-agent-active-dashboard.png)
...
![FIM directory configuration](files/07-fim-config.png)
...
![FIM alert in the dashboard](files/08-fim-alert-verification.png)
